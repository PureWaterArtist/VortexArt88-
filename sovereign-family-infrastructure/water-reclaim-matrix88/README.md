# 👑 SUB-MODULE 02: Mangrove-Biomimetic Closed-Loop Graywater Sieve
**Path Layer:** `sovereign-family-infrastructure/water-reclaim-matrix88/`
**Licensing Framework:** CERN Open Hardware Licence Strongly Reciprocal v2.0 (CERN-OHL-S-2.0)
**System Architecture:** 20nm Graphene Oxide Membranes // Solar UV Disinfection Chute
...
*   **`README.md`:** This file (Graywater Sieve Gateway Manual).
*   **`compile_filter_engine.py`:** Parametric SolidPython CAD Mesh Core Compiler Script.
*   **`simulate_filter_math.py`:** Independent Python 3 Mass Flow and Purity Hydraulics Simulator.
*   **`config/README.md`:** Reference Index Manual for all parameter cards.
*   **`config/technical-specs.md`:** Human-readable spec sheets, nanopore boundaries, and fluid velocities.
*   **`config/HARDWARE_BOM.md`:** Transparent, itemized $185 workshop procurement card.
*   **`config/WATER_EXPLAINER.md`:** Plain-English neighborhood operational guide and search target.
