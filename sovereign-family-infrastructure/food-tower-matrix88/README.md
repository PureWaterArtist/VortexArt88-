# 👑 SUB-MODULE 03: Redwood-Biomimetic Vertical Aeroponic Food Tower
**Path Layer:** `sovereign-family-infrastructure/food-tower-matrix88/`
**Licensing Framework:** CERN Open Hardware Licence Strongly Reciprocal v2.0 (CERN-OHL-S-2.0)
**System Architecture:** Peristaltic Siphon Core Tuba // 0.3mm Brass Swirl Nozzles
...
*   **`README.md`:** This file (Food Tower Gateway Manual).
*   **`compile_tower_engine.py`:** Parametric SolidPython CAD Mesh Core Compiler Script.
*   **`simulate_tower_math.py`:** Independent Python 3 Capillary Lift and Grow Yield Simulator.
*   **`config/README.md`:** Reference Index Manual for all parameter cards.
*   **`config/technical-specs.md`:** Human-readable spec sheets, capillary limits, and crop yield ceilings.
*   **`config/HARDWARE_BOM.md`:** Transparent, itemized $165 workshop procurement card.
*   **`config/FOOD_EXPLAINER.md`:** Plain-English neighborhood operational guide and search target.
