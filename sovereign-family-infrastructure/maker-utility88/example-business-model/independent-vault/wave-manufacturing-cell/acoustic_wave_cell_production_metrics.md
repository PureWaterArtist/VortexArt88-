...
## 🔧 2. PRE-FLIGHT NOZZLE PLATFORM HARDWARE COVENANTS

To maintain absolute system safety during continuous multi-device automated manufacturing runs, the hardware cell enforces three strict physical check limits:

1.  **The 2.0 Bar Pneumatic Safety Interlock:** Air cooling line pressure inside the internal coaxial scrubber jacket must maintain a continuous minimum threshold of 1.5 Bar. If pressure drops below this boundary, the print server will trigger an immediate emergency heater shutdown to prevent ceramic depolarization.
2.  **The M6 Torque Stabilization Boundary:** The three high-tensile steel mounting bolts must remain torqued to exactly 6.8 Nm against the flared geometric fillet loops to safely absorb the high cyclic vibration energy of the 120 Hz bed oscillator.
3.  **The 5.0-Minute Thermal Flush Standby:** Following the conclusion of any high-temperature extrusion file, the compressed air line must remain open at full operational pressure for exactly 300 seconds to completely flush out residual latent core heat.
