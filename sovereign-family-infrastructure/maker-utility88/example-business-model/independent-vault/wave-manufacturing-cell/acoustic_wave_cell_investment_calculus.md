...
## 📈 1. PROTOTYPE TOOLING COMPONENTS & SOURCING BALANCES

All components are current, standardized industrial lots sourced through direct trade channels, keeping your setup capital completely de-risked:

*   **Custom Machined Coaxial Brass Nozzle Block (The Master Chassis):**
    *   *Sourcing Spec:* **Symmetrical Hexagonal Stainless Steel Core Block** machined via local Livonia tool-and-die counters to match your `acoustic_rayleigh_wave_cell.scad` code, featuring the internal 4.0mm coaxial pneumatic air-cooling jacket.
    *   *Extended Cost:* **$320.00 USD** (One-time custom machining fee).
*   **Piezoelectric Ring Array Node (High-Velocity Transducer Pads):**
    *   *Sourcing Spec:* **PZT-4 Lead Zirconate Titanate Ceramic Ring Elements** (40 kHz, 10mm x 5mm x 2mm rings). Sourced in industrial 10-piece matching frequency lots.
    *   *Extended Cost:* **$145.00 USD**
*   **Dual-Channel High-Frequency Ultrasonic Power Generator:**
    *   *Sourcing Spec:* **40 kHz Sweep-Frequency Digital Ultrasonic Driver Board** containing internal thermal-overload protection circuits to drive the PZT-4 rings at continuous wave modes.
    *   *Extended Cost:* **$188.00 USD**
*   **Low-Frequency Mechanical Torsional Bed Oscillator:**
    *   *Sourcing Spec:* **Dayton Audio 120Hz Heavy-Duty Industrial Linear Bass Shaker Exciter** bolted directly underneath your PEI spring steel plates via the flared M6 anti-fatigue mounting tabs.
    *   *Extended Cost:* **$84.00 USD**
*   **Pneumatic Air-Cooling Regulator & Micro-Metered Valve Line:**
