...
## 🔩 1. Structural Fasteners & Clamping Chassis
These components form the rigid skeleton of the tower. They lock the stacked 3D-printed sub-modules into tight vertical compression, neutralizing structural separation and micro-leak channels under high pressure.

*   **M6 Threaded Structural Tie-Rods [Qty: 4]**
    *   *Specification:* Stainless Steel (Grade 316 Marine-Grade), Length: 1000mm, Thread Pitch: 1.0mm.
*   **M6 Hex Coupling Nuts [Qty: 8]**
    *   *Specification:* Stainless Steel (Grade 316), Length: 30mm long profile with clear internal M6x1.0 threads to join vertical rods securely across the full 3-meter tower span.
*   **M6 Nylon-Insert Locknuts [Qty: 8]**
    *   *Specification:* Stainless Steel heavy hex locking nuts equipped with high-durability internal nylon collars to prevent vibrational spinning under intense cavitation resonance.
*   **M6 Heavy-Duty Flat Washers [Qty: 16]**
    *   *Specification:* Stainless Steel, oversized mudguard/fender style layout to distribute clamping torque evenly across the 3D-printed plastic mounting ears.
...
*   **N52 Neodymium Ring Magnets [Qty: 6]**
    *   *Specification:* Rare-Earth Magnet Grade N52, Outer Diameter (OD): 76.2mm, Inner Diameter (ID): 51.5mm, Thickness: 25.4mm, Axial Magnetization.
*   **High-Purity Graphite Rods [Qty: 6]**
    *   *Specification:* Diameter: 6.35mm (1/4"), Length: 50mm, Grade: High-Density Isostatic carbon stock.
*   **Flexible Monocrystalline Solar Panels [Qty: 3]**
    *   *Specification:* Weatherproof Marine-Grade ETFE Coating, Dimensions: 1050mm x 140mm, Nominal Power Rating: 50W each (Parallel circuit architecture links them to form a unified 150W exoskeleton array).
*   **PZT-5H Lead Zirconate Titanate Ceramic Rings [Qty: 4]**
    *   *Specification:* Piezoelectric Element, OD: 65.0mm, ID: 51.5mm, Thickness: 5.0mm, featuring high-purity silver electroded faces for direct current pick-up connection.
*   **Enamelled Copper Magnet Wire [Qty: 1.5 kg]**
    *   *Specification:* Gauge: 24 AWG, Polyurethane-Polyamide heavy-build insulation layering ($155^\circ\text{C}$ thermal limit) for winding the 500-turn secondary Faraday induction spools.
*   **Stainless Steel Concentric Mesh Grid [Qty: 1 Sheet]**
    *   *Specification:* Woven Wire Mesh (Grade 316), Wire Diameter: 0.8mm, Mesh Aperture Size: 2.0mm.
*   **Insulated Stainless Steel Ionization Needles [Qty: 8]**
    *   *Specification:* Solid Grade 316 Stainless Steel pins, Length: 35mm, featuring a sharp needle apex profile (tip radius $<0.05\text{mm}$).
...
*   **2200uF Electrolytic Smoothing Capacitors [Qty: 2]**
    *   *Specification:* Capacitance: 2200uF, Rated Voltage: 63V, Low-ESR, Radial Lead profile ($105^\circ\text{C}$ endurance).
*   **Double-Sided Fiberglass Perfboard [Qty: 1]**
    *   *Specification:* Material: FR-4 Flame Retardant, Dimensions: 100mm x 150mm, featuring pre-drilled tinned component holes.
...
*   **Weighted Brass Hydraulic Ram Waste Valve [Qty: 1]**
    *   *Specification:* 1" NPT Thread connection, swing-check design equipped with an integrated 350g counterweight arm.
*   **EPDM Rubber O-Rings [Qty: 12]**
    *   *Specification:* Inside Diameter (ID): 25mm, Cross-Section Thickness: 3.5mm, Hardness Durometer rating: 70A.
*   **High-Density Teflon PTFE Pipe Tape [Qty: 2 Rolls]**
    *   *Specification:* Premium industrial sealing density, Width: 1/2".
*   **NSF-61 Food-Safe Silicone Grease [Qty: 1 Tube]**
    *   *Specification:* Pure waterproof polydimethylsiloxane compound, NSF-61 certified for safe drinking water systems.
